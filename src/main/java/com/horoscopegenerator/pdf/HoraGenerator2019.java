...
//        sw.swe_set_ephe_path("/temp/ephe"); //TODO: Ensure this is removed before creating apk
        // Set sidereal mode:
...
//        if (isLocal)
//            return new HoraPdfCreator2019().generateLocalPdf(birthChart, nativeDetails.getFilePath(), nativeDetails.getImageData());
//        else
//            return new HoraPdfCreator2019().generatePdf(birthChart, "test.pdf");

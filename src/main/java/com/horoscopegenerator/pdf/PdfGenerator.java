...
//            section3.addCell(miscTable);
//
//            //TODO Commented only for phd Start
//            section3.addCell(addRahuKetuRepTable(birthChart));
//
//            section3.addCell(addDBA(birthChart));
//
...
//            section3.getRow(3).getCells()[0].setBorder(Rectangle.NO_BORDER);
//
//            //TODO Commented only for phd End
//
//            addEmptyLinesToPDF(10);
//
//            addEmptyLinesToPDF(1);
...
//
////            writeToFile(filePath, jands);
//
//            PdfPTable jandsTable = new PdfPTable(1);
////            jandsTable.set
//
//            PdfPCell cell = new PdfPCell();
//            cell.addElement(new Phrase(jands, new Font(this.baseFont, HoraStrings.EXTRA_MEDIUM_FONT_SIZE + 1, 0, BaseColor.BLACK)));
//            cell.setBorder(0);
//
...
//
////            String sunRiseTime = String.valueOf(getDisplayDate(birthChart.getSunriseTime()));
////            jandsTable.addCell(new Phrase(sunRiseTime, new Font(this.baseFont, HoraStrings.EXTRA_MEDIUM_FONT_SIZE + 1, 0, BaseColor.BLACK)));
////
//
...
//    }
//
//	private static Planet[] getJeevaSareeraPlanets(BirthChart birthChart, Planet forPlanet, PlanetInfo currentPlanet) {
//
//        StringBuilder sb = new StringBuilder();
//
//
...
//
//
//    public static void calcJSAndGuna(BirthChart birthChart) throws DocumentException {
//        for (Planet planet : Planet.values()) {
//            PlanetInfo currentPlanet = null;
//            for (PlanetInfo planetInfo : birthChart.getRaasiChakra().getPlanetInfo()) {
//                if (planetInfo.getPlanet() == planet) {
